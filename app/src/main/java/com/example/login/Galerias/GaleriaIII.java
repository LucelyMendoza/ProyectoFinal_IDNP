...
public class GaleriaIII extends View {

    private Canvas _canvas;
    private List<PointRoom> points;
    private Context context;

    public GaleriaIII(Context context) {
        super(context);
        init(context);
    }

    public GaleriaIII(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public GaleriaIII(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void drawText() {
        ...
        _canvas.drawText("Galería III", centerX, centerY + 30, paint); // Ajustar la posición del texto si es necesario
    }
}
